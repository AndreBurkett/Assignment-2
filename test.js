...
var cssMove = function(moved)
{
	var selection = $("#moveButton").html();
  if(selection == "Move Right"){
    moveRight();
    $("#moveButton").html("Move Left");
  }
  else{
    moveLeft();
    $("#moveButton").html("Move Right");
  }
}
...
var moveBoxRight= function(n, easing, duration)
{
  ...
  if(jq){
	...
	document.getElementById(cssId).style.transition = 'all 2s '+easing+' '+duration+'ms';
	document.getElementById(cssId).style.backgroundColor = ec;
	document.getElementById(cssId).style.marginLeft = pageWidth-boxWidth+"px";
...
var moveBoxLeft= function(n, easing, duration)
{
  ...
  if(jq){
	...
	document.getElementById(cssId).style.transition = 'all 2s '+easing+' '+duration+'ms';
	document.getElementById(cssId).style.backgroundColor = ec;
	document.getElementById(cssId).style.marginLeft = "0px";
    console.log("Write this code");
  }
}
